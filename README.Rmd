...
Libraries were prepared as described previously in [Urich et al. 2012](http://www.nature.com/nprot/journal/v10/n3/full/nprot.2014.114.html) with minor modifications. See details of the library preparation protocol in supplementary file XXXX.xlsx [link to supplementary](link to supplementary)
...
* methylKit R packages and dependencies
...
We generated WGBS data for 83 accessions from Cape Verde - Santo Antao, 9 from Cape Verde - Fogo, 20 from Morocco and diverse mutants (ARABIDILLO-1 and CMT2). We also included as control the accessions Col-0, Col-3, Doer-10, and UKID116. The data for the fastq files for these samples can be downloaded in the NCBI depository PRJNA612437.
