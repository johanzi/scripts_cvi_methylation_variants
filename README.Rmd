...
The paired-end sequencing data of the 189 CVI accessions from Santo Antao were published in [Fulgione et al 2022](https://www.nature.com/articles/s41467-022-28800-z) and are available in ENA (accession code PRJEB39079 https://www.ebi.ac.uk/ena/browser/view/PRJEB39079).
...
while read i; do
  accession_ID=$(echo "$i" | cut -f1)
  echo "fasterq-dump $accession_ID -S -e 6 --split-files -O output_dir/"
  fasterq-dump $accession_ID -S -e 6 --split-files -O output_dir/
done < <(grep "^ERR" data/WGS_ENA_data_189_SA.txt)
