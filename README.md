...
Version with jittered plot

``` r
#jitter coordinates 
b <- runif(nrow(df_vim2_coord), -0.004, 0.004)
c <- runif(nrow(df_vim2_coord), -0.004, 0.004) ## you may need to adjust the 0.004 in your plot

df_vim2_coord$lat <- df_vim2_coord$lat + b
df_vim2_coord$long <- df_vim2_coord$long + c


ggplot(df_vim2_coord, aes(long, lat)) +
  geom_map(map = world, aes(map_id = region), fill = NA, color = "black") +
  coord_quickmap() +
  xlim(-25.1, -25.01) +
  ylim(17.09, 17.135) +
